function [mean_events_image, events_per_trial] = get_mean_events_image(results_grid, burn_in, do_plot, est_flag)
    ...
    for j = 1:size(results_grid,2)
        ...
        for k = 1:length(results_grid{i,j})
            ...
            posterior = ...
                ...
                [burn_in length(results_grid{i,j}(k).num_events)], [100 800],[0 Inf]);
